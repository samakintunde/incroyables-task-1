					...
					<div class="col-md-12 body-nofooter fullvw header">
						...
						<div class="col-md-12">
							<div class="col-md-8 content-side" style="z-index: 1">
								...
								<div class="col-12"><h1>HELLO <span style="text-transform: uppercase;"><?php echo $_SESSION['fullname'] ?? ''; ?> <span>!</h1>
										  ...
										  <div class="modal-dialog" role="document">
										    <div class="modal-content">
										      ...
										      <div class="modal-body">
										        <center><h1>Yay!!!</h1>
										        <h4>You are officially a super Hero now!!!</h4></center>
										      </div>
										    </div>
										  </div>
										</div>
												      ...
												      <div class="modal-body  col-10">
												        <div class="forgotText">
												        	<center><p>Are you Sure?</p></center>
																...
																<a href="logout.php"><button href="#" class="btn btn-primary  col-sm-6">Yes</button></a>
